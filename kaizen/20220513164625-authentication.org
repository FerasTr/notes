...
* HTTP Authentication
The HTTP protocol includes its own mechanism for authenticating users using various authentication schemes:
- *Basic* is a simple authentication mechanism that sends the user's username and password encoded in [[id:8853365a-91be-4264-8101-08e63d3991f3][base64]].
- *NTLM* is a challenge-response mechanism that uses a version of windows [[id:ae0695e6-1586-4aea-a814-eb4c0cfb5a60][NTLM]] protocol.
- *Digest* is a challenge-response mechanism that uses [[id:fe1fbf62-c008-486c-aeff-0a0318fe2ec2][MD5]] checksums of a nonce with the user's credentials.

These mechanisms are more common within organizations to access intranet-based services.
